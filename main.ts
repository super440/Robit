/*
Copyright (C): 2023-2024, Shenzhen BuildGenius
modified from BuildGenius
load dependency
"Robit": "file:../pxt-Robit"
*/

//% color="#0000FF" weight=20 icon="\u1f697"
namespace Robit {
    ...
    //% blockId=Robit_RGB_Car_Big2 block="RGB_Car_Big2|value1 %value1|value2 %value2|value3 %value3"
    //% weight=97
    //% blockGap=10
    ...
    //% blockId=Robit_Music_Car block="Music_Car|%index"
    //% weight=95
    //% blockGap=10
    //% color="#006400"
    //% name.fieldEditor="gridpicker" name.fieldOptions.columns=4
    ...
    //% blockId=Robit_CarCtrl block="CarCtrl|%index"
    //% weight=93
    //% blockGap=10
    //% color="#006400"
    ...
    //% blockId=Robit_CarCtrlSpeed block="CarCtrlSpeed|%index|speed %speed"
    //% weight=92
    //% blockGap=10
    ...
    //% blockId=Robit_CarCtrlSpeed2 block="CarCtrlSpeed2|%index|speed1 %speed1|speed2 %speed2"
    //% weight=91
    //% blockGap=10
    ...
    //% blockId=Robit_Line_Sensor block="Line_Sensor|direct %direct|value %value"
    //% weight=89
    //% blockGap=10
    //% color="#006400"
    ...
    //% blockId=Robit_Voice_Sensor block="Voice Sensor return"
    //% weight=88
    //% blockGap=10
    //% name.fieldEditor="gridpicker" name.fieldOptions.columns=12
    ...
    //% blockId=Robit_Ultrasonic_Car block="ultrasonic return distance(cm)"
    //% color="#006400"
    //% weight=87
    //% blockGap=10
    //% name.fieldEditor="gridpicker" name.fieldOptions.columns=4
